<template>
  <form-field label="Тип розподілу комісії" :error="error">
    <select-field
      :options="comissionTypes"
      name="comissionTypes"
      input-placeholder="Оберіть тип розподілу комісії"
      search-placeholder="Введіть тип розподілу комісії"
      :has-search="false"
...
export default defineComponent({
  ...
  computed: {
    comissionTypes(): { value: string; label: string }[] {
      ...
      return ref.comis_type.map((type) => ({
